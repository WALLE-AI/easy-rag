...
def test_llm():
    ...
    provider_instance = ModelProviderFactory().get_provider_instance('tongyi')
    ...
    model_instance = ModelInstance(provider_model_bundle=provider_model_bundle, model='qwen-vl-max')
