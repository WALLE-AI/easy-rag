...
from rag.entities.datasource_type import DatasourceType
from rag.entities.document import Document
from rag.entities.extract_setting import ExtractSetting
from rag.extractor.csv_extractor import CSVExtractor
from rag.extractor.excel_extractor import ExcelExtractor
from rag.extractor.html_extractor import HtmlExtractor
from rag.extractor.markdown_extractor import MarkdownExtractor
from rag.extractor.pdf_extractor import PdfExtractor
from rag.extractor.text_extractor import TextExtractor
from rag.extractor.unstructured.unstructured_eml_extractor import UnstructuredEmailExtractor
from rag.extractor.unstructured.unstructured_epub_extractor import UnstructuredEpubExtractor
from rag.extractor.unstructured.unstructured_markdown_extractor import UnstructuredMarkdownExtractor
from rag.extractor.unstructured.unstructured_msg_extractor import UnstructuredMsgExtractor
from rag.extractor.unstructured.unstructured_ppt_extractor import UnstructuredPPTExtractor
from rag.extractor.unstructured.unstructured_pptx_extractor import UnstructuredPPTXExtractor
from rag.extractor.unstructured.unstructured_text_extractor import UnstructuredTextExtractor
from rag.extractor.unstructured.unstructured_xml_extractor import UnstructuredXmlExtractor
from rag.extractor.word_extractor import WordExtractor
from services.db_model.uploadfile import UploadFile
from services.storge import storage
from utils import ssrf_proxy
    ...
    def extract(
        ...
        if extract_setting.datasource_type == DatasourceType.FILE.value:
            with tempfile.TemporaryDirectory() as temp_dir:
                ...
                unstructured_api_url = app_config.UNSTRUCTURED_API_URL
                unstructured_api_key = app_config.UNSTRUCTURED_API_KEY
